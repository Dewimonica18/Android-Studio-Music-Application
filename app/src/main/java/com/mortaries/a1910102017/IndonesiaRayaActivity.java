...
public class IndonesiaRayaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indonesia_raya);
        ActionBar actionBar;
        ...
        player = MediaPlayer.create(this, R.raw.indonesia_raya);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent next = new Intent(IndonesiaRayaActivity.this, MajuTakGentarActivity.class);
                startActivity(next);
            }
        });
        btnprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent prev = new Intent(IndonesiaRayaActivity.this, IndonesiaPusakaActivity.class);
                startActivity(prev);
            }
        });
