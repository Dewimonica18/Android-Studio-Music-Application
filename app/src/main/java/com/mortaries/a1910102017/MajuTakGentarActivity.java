...
public class MajuTakGentarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maju_tak_gentar);
        ActionBar actionBar;
        ...
        player = MediaPlayer.create(this, R.raw.maju_tak_gentar);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent next = new Intent(MajuTakGentarActivity.this, RayuanPulauKelapaActivity.class);
                startActivity(next);
            }
        });
        btnprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent prev = new Intent(MajuTakGentarActivity.this, IndonesiaRayaActivity.class);
                startActivity(prev);
            }
        });
