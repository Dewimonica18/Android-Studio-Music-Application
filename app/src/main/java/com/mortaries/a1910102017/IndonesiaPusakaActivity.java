...
public class IndonesiaPusakaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indonesia_pusaka);
        ActionBar actionBar;
        ...
        player = MediaPlayer.create(this, R.raw.indonesia_pusaka);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent next = new Intent(IndonesiaPusakaActivity.this, IndonesiaRayaActivity.class);
                startActivity(next);
            }
        });
        btnprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent prev = new Intent(IndonesiaPusakaActivity.this, MusicPlayerActivity.class);
                startActivity(prev);
            }
        });
