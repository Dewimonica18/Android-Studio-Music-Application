...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player = MediaPlayer.create(this, R.raw.garuda_pancasila);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent next = new Intent(MusicPlayerActivity.this, IndonesiaPusakaActivity.class);
                startActivity(next);
            }
        });
        btnprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.stop();
                Intent prev = new Intent(MusicPlayerActivity.this, RayuanPulauKelapaActivity.class);
                startActivity(prev);
            }
        });
